...
const server = http.createServer(async (req, res) => {
  ...
  // RUTA 2: GENERACIÓN DE PDF (CON PUPPETEER ESTABILIZADO)
  if (req.method === 'POST' && pathname === '/api/generate-pdf') {
    try {
      ...
      // Lanzamos el navegador virtual (Configuración estable para Render)
